...
- Have the following sections:
    ...
    - Usage instructions. Include a subsection for setup instructions.
    ...
    - A tree diagram of the modules, directories and file structure as it would look if we were to created by running `tree` on a linux system. Folders come first, then files. Alphabetized with folders and files starting with a `.` at the top.
